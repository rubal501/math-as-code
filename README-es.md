...
Esta es una referencia para acercar a desarrolladores a la notación matemática mostrando comparaciones con código de JavaScript


Motivación: los documentos académicos pueden ser intimidantes para los programadores de juegos y gráficos autodidactas. :)

Esta guia no esta completa. Si ves errores o quieres contribuir, por favor[abre una issue](https://github.com/Jam3/math-as-code/issues) or send a PR.

> **Nota**: Por brevedad, algunos ejemplos usan [paquetes de NPM](https://www.npmjs.com/).Puedes revisar sus respectivos repositorios de GitHub  para conocer detalles de implementación.
...
Los símbolos matemáticos pueden significar cosas diferentes dependiendo del autor, el contexto y el campo de estudio (álgebra lineal, teoría de conjuntos, etc). Es posible que esta guía no cubra *todos* los usos de un símbolo. En algunos casos, se citarán referencias del mundo real (entradas de blog, publicaciones, etc.) para demostrar cómo un símbolo puede aparecer en la naturaleza.
...
- [Raices Cuadradas y numeros complejos `√` *`i`*](#square-root-and-complex-numbers)
- [Punto y cruz `·` `×` `∘`](#dot--cross)
  - [Multiplicación por escalar](#scalar-multiplication)
  - [Multiplicación vectorial](#vector-multiplication)
  - [Producto punto](#dot-product)
  - [Producto Cruz](#cross-product)
- [Sumatorio `Σ`](#sigma) - *summation*
- [Productorio `Π`](#capital-pi) - *products of sequences*
- [pipes `||`](#pipes)
  - [Valore absoluto](#absolute-value)
  - [Euclidean norm](#euclidean-norm)
  - [Determinantes](#determinant)
- [hat **`â`**](#hat) - *unit vector*
- ["Pertenece a " `∈` `∉`](#element)
- [Conjuntos comunes de numeros `ℝ` `ℤ` `ℚ` `ℕ`](#common-number-sets)
- [Función `ƒ`](#function)
...
- [Flechas](#arrows)
  - [Implicación `⇒` `→`](#material-implication)
  - [Igualdad `<` `≥` `≫`](#equality)
  - [Conjunción y disjunción `∧` `∨`](#conjunction--disjunction)
- [Negación lógica `¬` `~` `!`](#logical-negation)
...
- *s* - italicas en minusculas para escalares (e.j. a number)
- **x** - negritas mayuscalas para vectores(e.j. a 2D point)
- **A** - mayusculas en negritas para matrices (e.j. a 3D transformation)
- *θ* - Minusculas en italicas para constantes y variables especiales (e.j. [ángulo polar *θ*, *theta*](https://es.wikipedia.org/wiki/Coordenadas_esféricas))

Esta notacion se usara en la guia
...
Often, the multiplication sign is only used to avoid ambiguity (e.j. between two numbers). Here, we can omit it entirely:
...
- *intersection* e.j. ![interval-intersection](http://latex.codecogs.com/svg.latex?%5B3%2C%205%29%20%5Ccap%20%5B4%2C%206%5D%20%3D%20%5B4%2C%205%29)

<!-- [3, 5) \cap [4, 6] = [4, 5) -->

- *union* e.j. ![interval-union](http://latex.codecogs.com/svg.latex?%5B3%2C%205%29%20%5Ccup%20%5B4%2C%206%5D%20%3D%20%5B3%2C%206%5D)

<!-- [3, 5) \cup [4, 6] = [3, 6] -->

- *difference* e.j. ![interval-difference-1](http://latex.codecogs.com/svg.latex?%5B3%2C%205%29%20-%20%5B4%2C%206%5D%20%3D%20%5B3%2C%204%29) and ![interval-difference-2](http://latex.codecogs.com/svg.latex?%5B4%2C%206%5D%20-%20%5B3%2C%205%29%20%3D%20%5B5%2C%206%5D)
